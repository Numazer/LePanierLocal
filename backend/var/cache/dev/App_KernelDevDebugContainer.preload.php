...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerFSwLesx\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerFSwLesx/UriSignerGhostB68a0a1.php';
require __DIR__.'/ContainerFSwLesx/EntityManagerGhost614a58f.php';
require __DIR__.'/ContainerFSwLesx/RequestPayloadValueResolverGhost01ca9cc.php';
require __DIR__.'/ContainerFSwLesx/getValidator_WhenService.php';
require __DIR__.'/ContainerFSwLesx/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerFSwLesx/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerFSwLesx/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerFSwLesx/getValidator_ExpressionService.php';
require __DIR__.'/ContainerFSwLesx/getValidator_EmailService.php';
require __DIR__.'/ContainerFSwLesx/getUriSignerService.php';
require __DIR__.'/ContainerFSwLesx/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerFSwLesx/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerFSwLesx/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerFSwLesx/getTwigService.php';
require __DIR__.'/ContainerFSwLesx/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerFSwLesx/getSession_FactoryService.php';
require __DIR__.'/ContainerFSwLesx/getServicesResetterService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerFSwLesx/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerFSwLesx/getSecrets_VaultService.php';
require __DIR__.'/ContainerFSwLesx/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerFSwLesx/getRouting_LoaderService.php';
require __DIR__.'/ContainerFSwLesx/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerFSwLesx/getLexikJwtAuthentication_KeyLoaderService.php';
require __DIR__.'/ContainerFSwLesx/getLexikJwtAuthentication_JwtManagerService.php';
require __DIR__.'/ContainerFSwLesx/getLexikJwtAuthentication_EncoderService.php';
require __DIR__.'/ContainerFSwLesx/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerFSwLesx/getErrorControllerService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerFSwLesx/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerFSwLesx/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerFSwLesx/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerFSwLesx/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerFSwLesx/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerFSwLesx/getContainer_GetenvService.php';
require __DIR__.'/ContainerFSwLesx/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerFSwLesx/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerFSwLesx/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerFSwLesx/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerFSwLesx/getCache_SystemClearerService.php';
require __DIR__.'/ContainerFSwLesx/getCache_SystemService.php';
require __DIR__.'/ContainerFSwLesx/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerFSwLesx/getCache_AppClearerService.php';
require __DIR__.'/ContainerFSwLesx/getCache_AppService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Validator_State_ErrorProviderService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Symfony_MainControllerService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_SwaggerUi_ProcessorService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_SwaggerUi_ContextService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_StateProvider_ParameterValidatorService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_StateProvider_ObjectService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_StateProvider_CreateService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_StateProvider_ContentNegotiationService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_StateProvider_BackedEnumService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_StateProcessor_WriteService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_State_ErrorProviderService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Serializer_FilterParameterProviderService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Openapi_SerializerContextBuilderService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Openapi_ProviderService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_JsonSchema_BackwardCompatibleSchemaFactoryService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_State_RemoveProcessorService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_State_PersistProcessorService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_State_ItemProviderService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_State_CollectionProviderService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_LinksHandlerService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Doctrine_Orm_Extension_ParameterExtensionService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Action_ErrorPageService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerFSwLesx/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerFSwLesx/getTemplateControllerService.php';
require __DIR__.'/ContainerFSwLesx/getRedirectControllerService.php';
require __DIR__.'/ContainerFSwLesx/getUserRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getUserFavoriteRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getTraderRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getSubCategoryRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getStockRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getSizeRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getReviewRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getProductRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getPictureRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getPictureProductRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getOrderRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getFavoriteRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getFashionRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getDiscountRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getCitiesRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getCategoryRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getCartRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getCartProductRepositoryService.php';
require __DIR__.'/ContainerFSwLesx/getUserRegisterControllerService.php';
require __DIR__.'/ContainerFSwLesx/getTraderRegisterControllerService.php';
require __DIR__.'/ContainerFSwLesx/getProductControllerService.php';
require __DIR__.'/ContainerFSwLesx/getLoginControllerService.php';
require __DIR__.'/ContainerFSwLesx/getFavoriteControllerService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_ZHyJIs5_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_ZHyJIs5_KernelloadRoutesService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_ZHyJIs5Service.php';
require __DIR__.'/ContainerFSwLesx/getProductControllershowService.php';
require __DIR__.'/ContainerFSwLesx/getProductControllerindexService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_VCPEyuwService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_I7qPdJrService.php';
require __DIR__.'/ContainerFSwLesx/getFavoriteControllerremoveFavoriteService.php';
require __DIR__.'/ContainerFSwLesx/getFavoriteControlleraddFavoriteService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_EgipcEHService.php';
require __DIR__.'/ContainerFSwLesx/getUserRegisterControllerregisterService.php';
require __DIR__.'/ContainerFSwLesx/getTraderRegisterControllerregisterTraderService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_EVyf_CTService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_AVKDDNUService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_ZyP9f7KService.php';
require __DIR__.'/ContainerFSwLesx/getProductControllernewService.php';
require __DIR__.'/ContainerFSwLesx/getProductControllereditService.php';
require __DIR__.'/ContainerFSwLesx/get_ServiceLocator_Pvsz2kiService.php';
require __DIR__.'/ContainerFSwLesx/getProductControllerdeleteService.php';
require __DIR__.'/ContainerFSwLesx/getFavoriteControllershowService.php';
require __DIR__.'/ContainerFSwLesx/getLoginControllerloginService.php';
require __DIR__.'/ContainerFSwLesx/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_UidService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_ValueResolver_ApiPlatform_ArgumentResolver_PayloadService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerFSwLesx/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Controller\TraderRegisterController';
$classes[] = 'App\Controller\UserRegisterController';
$classes[] = 'App\Repository\CartProductRepository';
...
$classes[] = 'App\Repository\FashionRepository';
$classes[] = 'App\Repository\FavoriteRepository';
$classes[] = 'App\Repository\OrderRepository';
$classes[] = 'App\Repository\PictureProductRepository';
...
$classes[] = 'App\Repository\TraderRepository';
$classes[] = 'App\Repository\UserFavoriteRepository';
