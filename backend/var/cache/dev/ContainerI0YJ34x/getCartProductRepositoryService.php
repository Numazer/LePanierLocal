 ...
 */
class getCartProductRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CartProductRepository' shared autowired service.
     *
     * @return \App\Repository\CartProductRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CartProductRepository.php';

        return $container->privates['App\\Repository\\CartProductRepository'] = new \App\Repository\CartProductRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
