 ...
 */
class getCitiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CitiesRepository' shared autowired service.
     *
     * @return \App\Repository\CitiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CitiesRepository.php';

        return $container->privates['App\\Repository\\CitiesRepository'] = new \App\Repository\CitiesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
