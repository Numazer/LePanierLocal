 ...
 */
class getFashionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FashionRepository' shared autowired service.
     *
     * @return \App\Repository\FashionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FashionRepository.php';

        return $container->privates['App\\Repository\\FashionRepository'] = new \App\Repository\FashionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
