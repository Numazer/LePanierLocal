 ...
 */
class getPictureProductRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PictureProductRepository' shared autowired service.
     *
     * @return \App\Repository\PictureProductRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PictureProductRepository.php';

        return $container->privates['App\\Repository\\PictureProductRepository'] = new \App\Repository\PictureProductRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
