 ...
 */
class getTraderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TraderRepository' shared autowired service.
     *
     * @return \App\Repository\TraderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TraderRepository.php';

        return $container->privates['App\\Repository\\TraderRepository'] = new \App\Repository\TraderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
