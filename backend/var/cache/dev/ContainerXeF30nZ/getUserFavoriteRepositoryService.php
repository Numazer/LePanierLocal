 ...
 */
class getUserFavoriteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserFavoriteRepository' shared autowired service.
     *
     * @return \App\Repository\UserFavoriteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserFavoriteRepository.php';

        return $container->privates['App\\Repository\\UserFavoriteRepository'] = new \App\Repository\UserFavoriteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
